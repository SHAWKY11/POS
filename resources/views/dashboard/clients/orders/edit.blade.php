                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('orders.index') }}">@yield('pagetitle2')</a>
                            </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" id="product-{{ $productt->id }}"
                                                            ...
                                                            class="btn {{ in_array($productt->id, $order->products->pluck('id')->toArray()) ? 'btn-default disabled' : 'btn-success add-product-btn' }} btn-sm">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <form action="{{ route('clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                            ...
                            <button class="btn btn-primary" id="form-btn"><i
                                    class="fa fa-edit"></i>
                                Edit_order</button>
